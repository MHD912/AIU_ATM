        ...
        <section class="home" id="home">
            ...
            <div class="max-width">
                <div class="home-content">
                    ...
                    <asp:Button ID="ButtonWithdraw" class="btn" Style="display: block; margin-top: 30px; margin-bottom: 30px; font-size: 23px" runat="server" Text="Withdraw Money" OnClick="ButtonWithdraw_Click" />
                </div>
            </div>
        </section>
    </form>
